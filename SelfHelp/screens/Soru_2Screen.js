        ...
        <SafeAreaView >
          <View style={styles.box}>
            ...
            <View>
                ...
                Sana yardımcı olmayı çok isterim, birlikte içinde bulunduğun mücadeleyi biraz incelememe müsaade eder misin?
                </Text>
            </View>
            ...
            <View   style={{marginHorizontal:100,marginTop:-180,}}> 
            <View style={{flexDirection:'row',marginLeft:-20}}>
                    <RadioButton
                        ...
                        <Text style={{fontSize:20,marginTop:3,color:"white",marginHorizontal:10}}>Müsaade ederim</Text>
                        </View>
                    ...
                    <RadioButton
                        ...
                        color="#afbf36"
                        uncheckedColor="white"/>
                        <Text style={{fontSize:20,marginTop:3,color:"white",marginHorizontal:10}}>Müsaade etmem</Text></View>
            </View>
          ...
          style={{marginRight:-7}}
            ...
            <Text style={{marginTop:37,fontSize:22,color:"black",marginLeft:10}}>2-15</Text>
            <TouchableOpacity
            style={{marginLeft:5}}
            onPress={()=> navigation.navigate("Soru_3")}
            className="p-3 rounded-tr-2xl rounded-bl-2xl ml-4 py-9">
