        ...
        <SafeAreaView >
          <View style={styles.box}>
            ...
            <View>
                ...
                <Text className=" text-xl text-black-700 ml-3 "  style={{color:"white",fontSize:20,marginTop:20,textAlign:"center", marginLeft:-10,paddingStart:40,paddingEnd:40}} >
                Bu zamana kadar bana verdiğin bilgiler için teşekkür ederim! Şimdi bu duyguları bedeninde nerede hissediyorsun, beraber buna bakmamızı ister misin?
                </Text>
            ...
            <View View   style={{marginHorizontal:90,marginTop:-130,flexDirection:'row',}}> 
            ...
            <View className="flex-row justify-center"style={{marginTop:190,marginRight:20}}>
          <TouchableOpacity 
          style={{marginRight:-7}}
            ...
            <Text style={{marginTop:37,fontSize:22,color:"black",marginLeft:10}}>7-15</Text>
            <TouchableOpacity
            style={{marginLeft:5}}
            onPress={()=> navigation.navigate("Soru_8")}
            className="p-3 rounded-tr-2xl rounded-bl-2xl ml-4 py-9">
