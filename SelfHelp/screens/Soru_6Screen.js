        ...
        <SafeAreaView >
          <View style={styles.box}>
            ...
            <View>
                ...
                Peki sence bu duygular ne kadar eski? (Hafta olarak)
                </Text>
          ...
          style={{marginRight:-7}}
            ...
            <Text style={{marginTop:37,fontSize:22,color:"black",marginLeft:10}}>6-15</Text>
            <TouchableOpacity
            style={{marginLeft:5}}
            onPress={()=> navigation.navigate("Soru_7")}
            className="p-3 rounded-tr-2xl rounded-bl-2xl ml-4 py-9">
