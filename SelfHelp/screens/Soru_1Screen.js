      ...
      <View style={styles.top}>
        <SafeAreaView >
          <View style={styles.box}>
            ...
            <View>
                <Text style={{color:"white",marginHorizontal:140,fontSize:25,}} >
                    MERHABA
                </Text>
                <Text className=" text-xl text-black-700 ml-3 "  style={{color:"white",fontSize:20,marginTop:50,textAlign:"center", marginLeft:-10,paddingStart:40,paddingEnd:40}} >
                    Bugün bu uygulamada bulunuyorsan, senin zor bir durumla mücadele ettiğini düşünüyorum.
                </Text>
          ...
          style={{marginRight:-7}}
            ...
            <Text style={{marginTop:37,fontSize:22,color:"black",marginLeft:10}}>1-15</Text>
            <TouchableOpacity
            style={{marginLeft:5}}
            onPress={()=> navigation.navigate("Soru_2")}
            className="p-3 rounded-tr-2xl rounded-bl-2xl ml-4 py-9">
