    ...
    <View style={styles.container}>
      <View style={styles.top}>
        <SafeAreaView >
          ...
          <Text className=" text-xl text-black-700 ml-3 "  style={{color:"white",fontSize:20,marginTop:70,textAlign:"center", marginLeft:-10,paddingStart:60,paddingEnd:60,marginTop:260}} >
          Bu zamana kadar verdiğin bilgiler için teşekkür ederim, harika gidiyorsun!
                </Text>
            <View >
          ...
          style={{marginRight:-7}}
            ...
            <Text style={{marginTop:37,fontSize:22,color:"black",marginLeft:10}}>10-15</Text>
            <TouchableOpacity
            style={{marginLeft:5}}
            onPress={()=> navigation.navigate("Soru_11")}
            className="p-3 rounded-tr-2xl rounded-bl-2xl ml-4 py-9">
